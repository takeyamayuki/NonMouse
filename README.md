...
## Usage
* app.pyはカメラがデスクライトのあたりにあることを想定して、パラメータを設定  
* appCeiling.pyはカメラを天井につけていることを想定して、パラメータを設定
* appFrCam.pyはノートパソコンについているカメラを使用して、指を画面に向かわせてマウスを動かします
### run
...
% python3 app.py
```
以下のように、カメラを複数搭載している場合は引数でカメラを選択できます  
```sh
