              ...
              <div className="flex flex-col items-center gap-3">
                {hasValidSupporterPaymentLink ? (
                  <a
                    ...
                    className="group inline-flex w-full max-w-[360px] overflow-hidden rounded-xl bg-[#FFDD00] leading-none shadow-sm transition-all hover:-translate-y-0.5 hover:shadow-md active:translate-y-0"
